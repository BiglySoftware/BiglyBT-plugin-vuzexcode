...
public class InternalTranscodeOperation2 extends AbstractTranscodeOperation {
	...
	public InternalTranscodeOperation2(TranscodeContext context) {
	...
	private String[] buildCommand() throws TranscodingException {
		...
		command.add(context.ffmpegPaths[1]);
		command.add("-y");
